...
{
  *os << "mylang::lex::tok::Token(\"" << utf8::utf16to8(tok.lexeme()) << "\", type=" << static_cast<int>(tok.type()) << ", line=" << tok.line()
      << ", col=" << tok.column() << ")";
}
...
TEST(LexerTest, RecognizesNoneKeyword)
{
  ...
  mylang::lex::Lexer lexer(&file_manager);
  auto tokens = lexer.tokenize();
  auto none_it = std::find_if(tokens.begin(), tokens.end(), [](const auto& tok) { return tok.type() == mylang::lex::tok::TokenType::KW_NONE; });
...
TEST(LexerTest, RecognizesBooleanKeywords)
{
  ...
  mylang::lex::Lexer lexer(&file_manager);
  auto tokens = lexer.tokenize();
  auto has_true = std::any_of(
    tokens.begin(), tokens.end(), [](const auto& tok) { return tok.type() == mylang::lex::tok::TokenType::KW_TRUE && tok.lexeme() == u"صحيح"; });
  auto has_false = std::any_of(
    tokens.begin(), tokens.end(), [](const auto& tok) { return tok.type() == mylang::lex::tok::TokenType::KW_FALSE && tok.lexeme() == u"خطا"; });
...
TEST(LexerTest, RecognizesExpression00)
{
  ...
  mylang::lex::Lexer lexer(&file_manager);
  auto tokens = lexer.tokenize();
  std::vector<mylang::lex::tok::Token> expected = {lexer.make_token(mylang::lex::tok::TokenType::BEGINMARKER, u"", 1, 1),
    lexer.make_token(mylang::lex::tok::TokenType::IDENTIFIER, u"س", 1, 1), lexer.make_token(mylang::lex::tok::TokenType::OP_EQ, u"=", 1, 3),
    lexer.make_token(mylang::lex::tok::TokenType::NUMBER, u"42", 1, 5), lexer.make_token(mylang::lex::tok::TokenType::OP_PLUS, u"+", 1, 8),
    lexer.make_token(mylang::lex::tok::TokenType::IDENTIFIER, u"ي", 1, 10), lexer.make_token(mylang::lex::tok::TokenType::ENDMARKER, u"", 1, 10)};
...
TEST(LexerTest, RecognizesStmt00)
{
  ...
  auto tokens = lexer.tokenize();
  std::vector<mylang::lex::tok::Token> expected = {lexer.make_token(mylang::lex::tok::TokenType::BEGINMARKER, u"", 1, 1),
    lexer.make_token(mylang::lex::tok::TokenType::KW_IF, u"اذا", 1, 1), lexer.make_token(mylang::lex::tok::TokenType::IDENTIFIER, u"س", 1, 5),
    lexer.make_token(mylang::lex::tok::TokenType::OP_EQ, u"=", 1, 7), lexer.make_token(mylang::lex::tok::TokenType::IDENTIFIER, u"د", 1, 9),
    lexer.make_token(mylang::lex::tok::TokenType::COLON, u":", 1, 10), lexer.make_token(mylang::lex::tok::TokenType::ENDMARKER, u"", 1, 10)};
...
TEST(LexerTest, RecognizesStmt01)
{
  ...
  auto tokens = lexer.tokenize();
  std::vector<mylang::lex::tok::Token> expected = {lexer.make_token(mylang::lex::tok::TokenType::BEGINMARKER, u"", 1, 1),
    lexer.make_token(mylang::lex::tok::TokenType::KW_WHILE, u"طالما", 1, 1), lexer.make_token(mylang::lex::tok::TokenType::IDENTIFIER, u"س", 1, 7),
    lexer.make_token(mylang::lex::tok::TokenType::OP_NEQ, u"!=", 1, 9), lexer.make_token(mylang::lex::tok::TokenType::IDENTIFIER, u"د", 1, 12),
    lexer.make_token(mylang::lex::tok::TokenType::COLON, u":", 1, 13), lexer.make_token(mylang::lex::tok::TokenType::ENDMARKER, u"", 1, 13)};
  EXPECT_EQ(tokens.size(), expected.size());
  EXPECT_EQ(tokens, expected);
}
...
TEST(LexerTest, RecognizesStmt02)
{
  ...
  auto tokens = lexer.tokenize();
  std::vector<mylang::lex::tok::Token> expected = {lexer.make_token(mylang::lex::tok::TokenType::BEGINMARKER, u"", 1, 1),
    lexer.make_token(mylang::lex::tok::TokenType::KW_FOR, u"بكل", 1, 1), lexer.make_token(mylang::lex::tok::TokenType::IDENTIFIER, u"ل", 1, 5),
    lexer.make_token(mylang::lex::tok::TokenType::IDENTIFIER, u"في", 1, 7), lexer.make_token(mylang::lex::tok::TokenType::IDENTIFIER, u"ك", 1, 10),
    lexer.make_token(mylang::lex::tok::TokenType::COLON, u":", 1, 11), lexer.make_token(mylang::lex::tok::TokenType::ENDMARKER, u"", 1, 11)};
  EXPECT_EQ(tokens.size(), expected.size());
  EXPECT_EQ(tokens, expected);
}
...
TEST(LexerTest, RecognizesStmt04)
{
  ...
  auto tokens = lexer.tokenize();
  std::vector<mylang::lex::tok::Token> expected = {lexer.make_token(mylang::lex::tok::TokenType::BEGINMARKER, u"", 1, 1),
    lexer.make_token(mylang::lex::tok::TokenType::KW_IF, u"اذا", 1, 1), lexer.make_token(mylang::lex::tok::TokenType::IDENTIFIER, u"ا", 1, 5),
    lexer.make_token(mylang::lex::tok::TokenType::OP_EQ, u"=", 1, 7), lexer.make_token(mylang::lex::tok::TokenType::NUMBER, u"3", 1, 9),
    lexer.make_token(mylang::lex::tok::TokenType::COLON, u":", 1, 10), lexer.make_token(mylang::lex::tok::TokenType::NEWLINE, u"\n", 1, 11),
    lexer.make_token(mylang::lex::tok::TokenType::INDENT, u"    ", 2, 5), lexer.make_token(mylang::lex::tok::TokenType::KW_RETURN, u"اخرج", 2, 5),
    lexer.make_token(mylang::lex::tok::TokenType::DEDENT, u"", 2, 9), lexer.make_token(mylang::lex::tok::TokenType::ENDMARKER, u"", 2, 8)};
  EXPECT_EQ(tokens.size(), expected.size());
  EXPECT_EQ(tokens, expected);
}