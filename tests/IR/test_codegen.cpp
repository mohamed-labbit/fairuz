...
{
    ast::LiteralExpr* literal = ast::makeLiteralInt(42);
    IR::Value result = codegen->eval(literal);

    EXPECT_TRUE(result.isNumber());
    EXPECT_DOUBLE_EQ(result.toFloat(), 42);
}

TEST_F(CodeGeneratorTest, EvalLiteralZero)
{
    ast::LiteralExpr* literal = ast::makeLiteralInt(0);

    IR::Value result = codegen->eval(literal);

    EXPECT_TRUE(result.isNumber());
    EXPECT_DOUBLE_EQ(result.toInt(), 0);
}

TEST_F(CodeGeneratorTest, EvalLiteralNegative)
{
    ast::LiteralExpr* literal = ast::makeLiteralFloat(-100.5);
...
{
    ast::LiteralExpr* literal = ast::makeLiteralBool(true);
...
{
    ast::BinaryExpr* expr = makeBinary(ast::makeLiteralInt(10), ast::makeLiteralInt(20), ast::BinaryOp::OP_ADD);

    IR::Value result = codegen->eval(expr);

    EXPECT_TRUE(result.isNumber());
    EXPECT_DOUBLE_EQ(result.toFloat(), 30);
}

TEST_F(CodeGeneratorTest, BinarySubtraction)
{
    ast::BinaryExpr* expr = makeBinary(ast::makeLiteralInt(50), ast::makeLiteralInt(30), ast::BinaryOp::OP_SUB);

    IR::Value result = codegen->eval(expr);

    EXPECT_TRUE(result.isNumber());
    EXPECT_DOUBLE_EQ(result.toFloat(), 20);
}

TEST_F(CodeGeneratorTest, BinaryMultiplication)
{
    ast::BinaryExpr* expr = makeBinary(ast::makeLiteralInt(6), ast::makeLiteralInt(7), ast::BinaryOp::OP_MUL);
...
{
    ast::BinaryExpr* expr = makeBinary(ast::makeLiteralInt(100), ast::makeLiteralInt(4), ast::BinaryOp::OP_DIV);

    IR::Value result = codegen->eval(expr);

    EXPECT_TRUE(result.isNumber());
    EXPECT_DOUBLE_EQ(result.toFloat(), 25);
}

TEST_F(CodeGeneratorTest, BinaryDivisionByZero)
{
    ast::BinaryExpr* expr = makeBinary(ast::makeLiteralInt(10), ast::makeLiteralInt(0), ast::BinaryOp::OP_DIV);
...
{
    // (10 + 20) * 3
    ast::BinaryExpr* inner = makeBinary(ast::makeLiteralInt(10), ast::makeLiteralInt(20), ast::BinaryOp::OP_ADD);
    ast::BinaryExpr* outer = makeBinary(inner, ast::makeLiteralInt(3), ast::BinaryOp::OP_MUL);

    IR::Value result = codegen->eval(outer);

    EXPECT_TRUE(result.isNumber());
    EXPECT_DOUBLE_EQ(result.toInt(), 90);
}

TEST_F(CodeGeneratorTest, BinaryNestedSubtraction)
{
    // 100 - (50 - 20)
    ast::BinaryExpr* inner = makeBinary(ast::makeLiteralInt(50), ast::makeLiteralInt(20), ast::BinaryOp::OP_SUB);
    ast::BinaryExpr* outer = makeBinary(ast::makeLiteralInt(100), inner, ast::BinaryOp::OP_SUB);

    IR::Value result = codegen->eval(outer);

    EXPECT_TRUE(result.isNumber());
    EXPECT_DOUBLE_EQ(result.toFloat(), 70);
}
...
{
    ast::BinaryExpr* expr = makeBinary(ast::makeLiteralInt(42), ast::makeLiteralInt(42), ast::BinaryOp::OP_EQ);
...
{
    ast::BinaryExpr* expr = makeBinary(ast::makeLiteralInt(10), ast::makeLiteralInt(20), ast::BinaryOp::OP_EQ);
...
{
    ast::BinaryExpr* expr = makeBinary(ast::makeLiteralInt(50), ast::makeLiteralInt(30), ast::BinaryOp::OP_GT);
...
{
    ast::BinaryExpr* expr = makeBinary(ast::makeLiteralInt(20), ast::makeLiteralInt(30), ast::BinaryOp::OP_GT);
...
{
    ast::BinaryExpr* expr1 = makeBinary(ast::makeLiteralInt(50), ast::makeLiteralInt(50), ast::BinaryOp::OP_GTE);
    ...
    ast::BinaryExpr* expr2 = makeBinary(ast::makeLiteralInt(51), ast::makeLiteralInt(50), ast::BinaryOp::OP_GTE);
...
{
    ast::BinaryExpr* expr = makeBinary(ast::makeLiteralInt(10), ast::makeLiteralInt(20), ast::BinaryOp::OP_LT);
...
{
    ast::BinaryExpr* expr1 = makeBinary(ast::makeLiteralInt(30), ast::makeLiteralInt(30), ast::BinaryOp::OP_LTE);
    ...
    ast::BinaryExpr* expr2 = makeBinary(ast::makeLiteralInt(29), ast::makeLiteralInt(30), ast::BinaryOp::OP_LTE);
...
{
    ast::UnaryExpr* expr = makeUnary(ast::makeLiteralInt(42), ast::UnaryOp::OP_NEG);
...
{
    ast::UnaryExpr* expr = makeUnary(ast::makeLiteralInt(-10), ast::UnaryOp::OP_NEG);

    IR::Value result = codegen->eval(expr);

    EXPECT_TRUE(result.isNumber());
    EXPECT_DOUBLE_EQ(result.toFloat(), 10);
}

TEST_F(CodeGeneratorTest, UnaryLogicalNot)
{
    ast::UnaryExpr* expr = makeUnary(ast::makeLiteralBool(true), ast::UnaryOp::OP_NOT);
...
{
    ast::UnaryExpr* expr = makeUnary(ast::makeLiteralBool(false), ast::UnaryOp::OP_NOT);
...
{
    ast::UnaryExpr* inner = makeUnary(ast::makeLiteralInt(5), ast::UnaryOp::OP_NEG);
    ast::UnaryExpr* outer = makeUnary(inner, ast::UnaryOp::OP_NEG);

    IR::Value result = codegen->eval(outer);

    EXPECT_TRUE(result.isNumber());
    EXPECT_DOUBLE_EQ(result.toFloat(), 5);
}
...
{
    ast::AssignmentExpr* expr = makeAssignmentExpr(ast::makeName("x"), ast::makeLiteralInt(42));
    ...
    EXPECT_DOUBLE_EQ(stored.toFloat(), 42);
}

TEST_F(CodeGeneratorTest, AssignmentOverwrite)
{
    // First assignment
    ast::AssignmentExpr* expr1 = makeAssignmentExpr(ast::makeName("y"), ast::makeLiteralInt(10));

    codegen->eval(expr1);

    // Second assignment (overwrite)
    ast::AssignmentExpr* expr2 = makeAssignmentExpr(ast::makeName("y"), ast::makeLiteralInt(20));
    ...
    EXPECT_DOUBLE_EQ(stored.toFloat(), 20);
}

TEST_F(CodeGeneratorTest, AssignmentExpression)
{
    // x = 10 + 20
    ast::BinaryExpr* value = makeBinary(ast::makeLiteralInt(10), ast::makeLiteralInt(20), ast::BinaryOp::OP_ADD);
...
TEST_F(CodeGeneratorTest, AssignmentInvalidTarget)
{
    ...
    ast::LiteralExpr* invalidTarget = makeLiteral(42);
    ast::AssignmentExpr* expr = ast::makeAssignmentExpr(invalidTarget, makeLiteral(10));
...
TEST_F(CodeGeneratorTest, NameExpressionExists)
{
    ...
    env->define(StringRef("myvar"), IR::Value(123));
    ...
    EXPECT_TRUE(result.isNumber());
    EXPECT_DOUBLE_EQ(result.toFloat(), 123);
}
...
TEST_F(CodeGeneratorTest, NameExpressionInExpression)
{
    ...
    env->define(StringRef("x"), IR::Value(10));

    ast::BinaryExpr* expr = makeBinary(ast::makeName("x"), ast::makeLiteralInt(5), ast::BinaryOp::OP_ADD);

    IR::Value result = codegen->eval(expr);

    EXPECT_DOUBLE_EQ(result.toFloat(), 15);
}
...
{
    ast::ListExpr* expr = ast::makeList({ ast::makeLiteralInt(42) });
    ...
    EXPECT_DOUBLE_EQ((*list)[0].toFloat(), 42);
}

TEST_F(CodeGeneratorTest, ListMultipleElements)
{
    ast::ListExpr* expr = ast::makeList({ ast::makeLiteralInt(1), ast::makeLiteralInt(2), ast::makeLiteralInt(3), ast::makeLiteralInt(4) });
    ...
    EXPECT_DOUBLE_EQ((*list)[0].toFloat(), 1);
    EXPECT_DOUBLE_EQ((*list)[1].toFloat(), 2);
    EXPECT_DOUBLE_EQ((*list)[2].toFloat(), 3);
    EXPECT_DOUBLE_EQ((*list)[3].toFloat(), 4);
}

TEST_F(CodeGeneratorTest, ListWithExpressions)
{
    // [10 + 5, 20 * 2]
    ast::ListExpr* expr = ast::makeList({ makeBinary(ast::makeLiteralInt(10), ast::makeLiteralInt(5), ast::BinaryOp::OP_ADD),
        makeBinary(ast::makeLiteralInt(20), ast::makeLiteralInt(2), ast::BinaryOp::OP_MUL) });
    ...
    EXPECT_DOUBLE_EQ((*list)[0].toFloat(), 15);
    EXPECT_DOUBLE_EQ((*list)[1].toFloat(), 40);
}

TEST_F(CodeGeneratorTest, ListMixedTypes)
{
    ast::ListExpr* expr = ast::makeList({ ast::makeLiteralInt(42), ast::makeLiteralBool(true), ast::makeLiteralFloat(-10.5) });
...
TEST_F(CodeGeneratorTest, CallInvalidCallee)
{
    ...
    ast::LiteralExpr* invalidCallee = ast::makeLiteralInt(42);
...
TEST_F(CodeGeneratorTest, CallUserFunctionNoArgs)
{
    ...
    func.params = {};
    func.body = ast::makeLiteralInt(100);
    ...
    EXPECT_TRUE(result.isNumber());
    EXPECT_DOUBLE_EQ(result.toFloat(), 100);
}
...
TEST_F(CodeGeneratorTest, CallUserFunctionWithArgs)
{
    ...
    func.body = ast::makeBinary(ast::makeName("a"), ast::makeName("b"), ast::BinaryOp::OP_ADD);
    func.closure = env.get();

    IR::Value funcValue = IR::Value::makeFunction(func);
    env->define(StringRef("add"), funcValue);

    ast::CallExpr* expr = makeCall("add", { ast::makeLiteralInt(10), ast::makeLiteralInt(20) });
    IR::Value result = codegen->eval(expr);
...
TEST_F(CodeGeneratorTest, CallUserFunctionWrongArgCount)
{
    ...
    func.body = ast::makeLiteralInt(0);
    func.closure = env.get();
    ...
    ast::CallExpr* expr = makeCall("twoArgs", { ast::makeLiteralInt(10) });
...
TEST_F(CodeGeneratorTest, CallEagerEvaluation)
{
    ...
    env->define(StringRef("x"), IR::Value(5));
    ...
    ast::BinaryExpr* arg = makeBinary(ast::makeName("x"), ast::makeLiteralInt(2), ast::BinaryOp::OP_MUL);
...
TEST_F(CodeGeneratorTest, FunctionLexicalScoping)
{
    ...
    env->define(StringRef("outer"), IR::Value(100));
...
TEST_F(CodeGeneratorTest, FunctionParameterShadowing)
{
    ...
    ast::CallExpr* expr = makeCall("getX", { ast::makeLiteralInt(99) });
    IR::Value result = codegen->eval(expr);

    // Should return parameter value, not outer variable
    EXPECT_DOUBLE_EQ(result.toFloat(), 99);

    // Outer variable should be unchanged
    EXPECT_DOUBLE_EQ(env->get(StringRef("x")).toFloat(), 10);
}

TEST_F(CodeGeneratorTest, FunctionEnvironmentRestore)
{
    // Define variable before function call
    env->define(StringRef("temp"), IR::Value(1));
    ...
    // Call function
    ast::CallExpr* expr = makeCall("useTemp", { ast::makeLiteralInt(999) });
    codegen->eval(expr);

    // Original environment variable should be unchanged
    EXPECT_DOUBLE_EQ(env->get(StringRef("temp")).toFloat(), 1);
}

TEST_F(CodeGeneratorTest, FunctionExceptionEnvironmentRestore)
{
    env->define(StringRef("orig"), IR::Value(50));
...
TEST_F(CodeGeneratorTest, UnknownBinaryOperator)
{
    ...
    ast::BinaryExpr* expr = makeBinary(ast::makeLiteralInt(1), ast::makeLiteralInt(2), static_cast<ast::BinaryOp>(9999));
...
{
    ast::UnaryExpr* expr = ast::makeUnary(ast::makeLiteralInt(5), static_cast<ast::UnaryOp>(8888));
...
{
    // (10 + 20) * (30 - 15) / 5
    ast::BinaryExpr* add = makeBinary(ast::makeLiteralInt(10), ast::makeLiteralInt(20), ast::BinaryOp::OP_ADD);
    ast::BinaryExpr* sub = makeBinary(ast::makeLiteralInt(30), ast::makeLiteralInt(15), ast::BinaryOp::OP_SUB);
    ast::BinaryExpr* mul = makeBinary(add, sub, ast::BinaryOp::OP_MUL);
    ast::BinaryExpr* div = makeBinary(mul, ast::makeLiteralInt(5), ast::BinaryOp::OP_DIV);

    IR::Value result = codegen->eval(div);

    EXPECT_DOUBLE_EQ(result.toFloat(), 90);
}

TEST_F(CodeGeneratorTest, ComplexComparisonChain)
{
    // (10 < 20) AND (30 > 15)  -- represented as separate evaluations
    ast::BinaryExpr* lt = makeBinary(ast::makeLiteralInt(10), ast::makeLiteralInt(20), ast::BinaryOp::OP_LT);
    ast::BinaryExpr* gt = makeBinary(ast::makeLiteralInt(30), ast::makeLiteralInt(15), ast::BinaryOp::OP_GT);
...
TEST_F(CodeGeneratorTest, ComplexWithVariables)
{
    ...
    env->define(StringRef("x"), IR::Value(10));
    env->define(StringRef("y"), IR::Value(20));

    ast::BinaryExpr* add = ast::makeBinary(ast::makeName("x"), ast::makeName("y"), ast::BinaryOp::OP_ADD);
    ast::BinaryExpr* mul = ast::makeBinary(add, ast::makeLiteralInt(2), ast::BinaryOp::OP_MUL);
    ast::AssignmentExpr* assign = ast::makeAssignmentExpr(ast::makeName("result"), mul);

    IR::Value result = codegen->eval(assign);

    EXPECT_DOUBLE_EQ(result.toFloat(), 60);
    EXPECT_DOUBLE_EQ(env->get(StringRef("result")).toFloat(), 60);
}
...
TEST_F(CodeGeneratorTest, NestedFunctionCalls)
{
    ...
    innerFunc.body = ast::makeBinary(ast::makeName("n"), ast::makeLiteralInt(2), ast::BinaryOp::OP_MUL);
    ...
    // Call outer function
    ast::CallExpr* expr = makeCall("quadruple", { ast::makeLiteralInt(5) });
    IR::Value result = codegen->eval(expr);
...
{
    ast::BinaryExpr* expr = makeBinary(ast::makeLiteralFloat(1e308), ast::makeLiteralFloat(1e308), ast::BinaryOp::OP_ADD);
...
{
    ast::BinaryExpr* expr = makeBinary(ast::makeLiteralFloat(1e-308), ast::makeLiteralFloat(1e-308), ast::BinaryOp::OP_MUL);
...
TEST_F(CodeGeneratorTest, RecursiveExpression)
{
    ...
    ast::Expr* expr = ast::makeLiteralInt(5);
    for (int i = 0; i < 4; ++i)
        expr = makeBinary(expr, ast::makeLiteralInt(5), ast::BinaryOp::OP_ADD);
...
{
    // x = 42
    ast::AssignmentStmt* stmt = ast::makeAssignmentStmt(ast::makeName("x"), ast::makeLiteralInt(42));
...
{
    // Define x first
    env->define(StringRef("x"), IR::Value::makeFloat(10));

    // x = 99
    ast::AssignmentStmt* stmt = makeAssignmentStmt(ast::makeName("x"), ast::makeLiteralInt(99));
    codegen->eval(stmt);

    // Variable should be updated
    IR::Value stored = env->get(StringRef("x"));
    EXPECT_DOUBLE_EQ(stored.toFloat(), 99);
}
...
TEST_F(CodeGeneratorTest, AssignmentStmtWithExpression)
{
    ...
    IR::Value stored = env->get(StringRef("y"));
    EXPECT_DOUBLE_EQ(stored.toFloat(), 30);
}

TEST_F(CodeGeneratorTest, AssignmentStmtChained)
{
    // a = 5
    ast::AssignmentStmt* stmt1 = makeAssignmentStmt(ast::makeName("a"), ast::makeLiteralInt(5));
    codegen->eval(stmt1);

    // b = a * 2
    ast::BinaryExpr* expr = makeBinary(ast::makeName("a"), ast::makeLiteralInt(2), ast::BinaryOp::OP_MUL);
    ast::AssignmentStmt* stmt2 = makeAssignmentStmt(ast::makeName("b"), expr);
    codegen->eval(stmt2);

    EXPECT_DOUBLE_EQ(env->get(StringRef("a")).toFloat(), 5);
    EXPECT_DOUBLE_EQ(env->get(StringRef("b")).toFloat(), 10);
}
...
TEST_F(CodeGeneratorTest, ExprStmtSimple)
{
    ...
    ast::ExprStmt* stmt = makeExprStmt(ast::makeLiteralInt(42));
    IR::Value result = codegen->eval(stmt);
...
TEST_F(CodeGeneratorTest, ExprStmtFunctionCall)
{
    ...
    func.params = nullptr;
    func.body = makeExprStmt(ast::makeLiteralInt(100));
    func.closure = env.get();
...
{
    // { 42; }
    ast::BlockStmt* block = ast::makeBlock({ makeExprStmt(ast::makeLiteralInt(42)) });
...
TEST_F(CodeGeneratorTest, BlockStmtMultiple)
{
    // { 10; 20; 30; }
    ast::BlockStmt* block = ast::makeBlock(
        { makeExprStmt(ast::makeLiteralInt(10)),
            makeExprStmt(ast::makeLiteralInt(20)),
            makeExprStmt(ast::makeLiteralInt(30)) });
...
TEST_F(CodeGeneratorTest, BlockStmtWithAssignments)
{
    // { x = 5; y = 10; x + y; }
    ast::BlockStmt* block = ast::makeBlock(
        { makeAssignmentStmt(ast::makeName("x"), ast::makeLiteralInt(5)), makeAssignmentStmt(ast::makeName("y"), ast::makeLiteralInt(10)),
            ast::makeExprStmt(ast::makeBinary(ast::makeName("x"), ast::makeName("y"), ast::BinaryOp::OP_ADD)) });
...
{
    // if (true) { 42; }
    ast::IfStmt* ifStmt = ast::makeIf(ast::makeLiteralBool(true), ast::makeBlock({ makeExprStmt(ast::makeLiteralInt(42)) }));
...
{
    // if (false) { 42; }
    ast::IfStmt* ifStmt = makeIf(ast::makeLiteralBool(false), ast::makeBlock({ makeExprStmt(ast::makeLiteralInt(42)) }));
...
TEST_F(CodeGeneratorTest, IfStmtTrueWithElse)
{
    ...
    ast::IfStmt* ifStmt = makeIf(
        ast::makeLiteralBool(true),
        ast::makeBlock({ makeExprStmt(ast::makeLiteralInt(10)) }),
        ast::makeBlock({ makeExprStmt(ast::makeLiteralInt(20)) }));
...
TEST_F(CodeGeneratorTest, IfStmtComparisonCondition_01)
{
    ...
    ast::IfStmt* ifStmt = makeIf(
        makeBinary(ast::makeName("x"), ast::makeLiteralInt(5), ast::BinaryOp::OP_GT),
        ast::makeBlock({ makeExprStmt(ast::makeLiteralInt(100)) }), ast::makeBlock({ makeExprStmt(ast::makeLiteralInt(200)) }));
...
{
    // if (true) { if (true) { 42; } }
    ast::IfStmt* innerIf = makeIf(ast::makeLiteralBool(true), ast::makeBlock({ makeExprStmt(ast::makeLiteralInt(42)) }));
    ast::IfStmt* outerIf = makeIf(ast::makeLiteralBool(true), ast::makeBlock({ innerIf }));
...
{
    // if (true) { x = 42; }
    ast::IfStmt* ifStmt = makeIf(ast::makeLiteralBool(true), ast::makeBlock({ makeAssignmentStmt(ast::makeName("x"), ast::makeLiteralInt(42)) }));

    codegen->eval(ifStmt);

    EXPECT_TRUE(env->exists(StringRef("x")));
    EXPECT_DOUBLE_EQ(env->get(StringRef("x")).toFloat(), 42);
}
...
TEST_F(CodeGeneratorTest, WhileStmtFalseCondition)
{
    ...
    env->define(StringRef("counter"), IR::Value::makeFloat(0));

    ast::WhileStmt* whileStmt = makeWhile(
        ast::makeLiteralBool(false),
        ast::makeBlock({ makeAssignmentStmt(ast::makeName("counter"),
            makeBinary(ast::makeName("counter"), ast::makeLiteralInt(1), ast::BinaryOp::OP_ADD)) }));

    IR::Value result = codegen->eval(whileStmt);

    // Counter should still be 0
    EXPECT_DOUBLE_EQ(env->get(StringRef("counter")).toFloat(), 0);
}
...
TEST_F(CodeGeneratorTest, WhileStmtAccumulator)
{
    ...
    EXPECT_DOUBLE_EQ(env->get(StringRef("ا")).toFloat(), 15);
    EXPECT_DOUBLE_EQ(env->get(StringRef("ب")).toFloat(), 6);
}
...
TEST_F(CodeGeneratorTest, FunctionDefNoParams)
{
    ...
    ast::FunctionDef* funcDef = ast::makeFunction(ast::makeName("getFortyTwo"), ast::makeList({}),
        ast::makeBlock({ makeExprStmt(ast::makeLiteralInt(42)) }));
...
TEST_F(CodeGeneratorTest, FunctionDefWithSingleParam)
{
    ...
    ast::FunctionDef* funcDef = ast::makeFunction(
        ...
        ast::makeBlock({ makeExprStmt(makeBinary(ast::makeName("x"), ast::makeLiteralInt(2), ast::BinaryOp::OP_MUL)) }));
...
TEST_F(CodeGeneratorTest, FunctionDefWithMultipleParams)
{
    ...
    ast::FunctionDef* funcDef = ast::makeFunction(
        ...
        ast::makeBlock({ ast::makeExprStmt(ast::makeBinary(ast::makeName("a"), ast::makeName("b"), ast::BinaryOp::OP_ADD)) }));
...
TEST_F(CodeGeneratorTest, FunctionDefAndCall)
{
    ...
    ast::FunctionDef* funcDef = ast::makeFunction(
        ...
        ast::makeBlock({ ast::makeExprStmt(ast::makeBinary(ast::makeName("n"), ast::makeName("n"), ast::BinaryOp::OP_MUL)) }));

    codegen->eval(funcDef);

    // Call the function
    ast::CallExpr* call = ast::makeCall(ast::makeName("square"), ast::makeList({ ast::makeLiteralInt(5) }));
...
TEST_F(CodeGeneratorTest, FunctionDefClosureCapture)
{
    ...
    env->define(StringRef("outer"), IR::Value::makeFloat(100));
...
TEST_F(CodeGeneratorTest, IntegrationFibonacciIterative)
{
    ...
    ast::FunctionDef* funcDef = ast::makeFunction(
        ...
        ast::makeBlock({ makeIf(
            ...
            ast::makeBlock({ ast::makeAssignmentStmt(ast::makeName("a"), ast::makeLiteralInt(0)),
                ast::makeAssignmentStmt(ast::makeName("b"), ast::makeLiteralInt(1)),
                ast::makeAssignmentStmt(ast::makeName("i"), ast::makeLiteralInt(2)),
                ast::makeWhile(ast::makeBinary(ast::makeName("i"), ast::makeName("n"), ast::BinaryOp::OP_LTE),
                    ast::makeBlock({ ast::makeAssignmentStmt(ast::makeName("temp"),
                                         ast::makeBinary(ast::makeName("a"), ast::makeName("b"), ast::BinaryOp::OP_ADD)),
    ...
    // Test fib(6) = 8
    ast::CallExpr* call = ast::makeCall(ast::makeName("fib"), ast::makeList({ ast::makeLiteralInt(6) }));
    IR::Value result = codegen->eval(call);

    // The result should be 8 (fibonacci of 6)
    EXPECT_EQ(result.toFloat(), 8);
}
...
TEST_F(CodeGeneratorTest, IntegrationFactorial)
{
    ...
    EXPECT_TRUE(result.isNumber());
    EXPECT_DOUBLE_EQ(result.toFloat(), 120);
}
...
TEST_F(CodeGeneratorTest, IntegrationNestedFunctions)
{
    ...
    ast::FunctionDef* innerFunc = ast::makeFunction(
        ...
        ast::makeBlock({ ast::makeExprStmt(ast::makeBinary(ast::makeName("x"), ast::makeName("y"), ast::BinaryOp::OP_ADD)) }));

    ast::FunctionDef* outerFunc = ast::makeFunction(
        ast::makeName("outer"),
        ast::makeList({ ast::makeName("x") }),
        ast::makeBlock({ innerFunc,
            ast::makeExprStmt(ast::makeCall(ast::makeName("inner"), ast::makeList({ ast::makeLiteralInt(10) }))) }));

    codegen->eval(outerFunc);

    ast::CallExpr* call = makeCall("outer", { ast::makeLiteralInt(5) });
    IR::Value result = codegen->eval(call);
...
{
    ast::BinaryExpr* eq = makeBinary(ast::makeLiteralInt(0), ast::makeLiteralInt(-0), ast::BinaryOp::OP_EQ);
...
{
    // x = 42
    ast::AssignmentStmt* stmt = makeAssignmentStmt(ast::makeName("x"), ast::makeLiteralInt(42));
    IR::Value result = codegen->eval(stmt);
...
TEST_F(CodeGeneratorTest, AssignmentStmtExpression)
{
    ...
    ast::AssignmentStmt* stmt = makeAssignmentStmt(ast::makeName("y"),
        makeBinary(ast::makeLiteralInt(10), ast::makeLiteralInt(20), ast::BinaryOp::OP_ADD));

    codegen->eval(stmt);

    EXPECT_TRUE(env->exists(StringRef("y")));
    EXPECT_DOUBLE_EQ(env->get(StringRef("y")).toFloat(), 30);
}

TEST_F(CodeGeneratorTest, AssignmentStmtReassign)
{
    // First assignment
    env->define(StringRef("z"), IR::Value::makeFloat(5));

    // Reassignment: z = 100
    ast::AssignmentStmt* stmt = makeAssignmentStmt(ast::makeName("z"), ast::makeLiteralInt(100));
    codegen->eval(stmt);

    EXPECT_DOUBLE_EQ(env->get(StringRef("z")).toFloat(), 100);
}

TEST_F(CodeGeneratorTest, AssignmentStmtMultipleVariables)
{
    // a = 1, b = 2, c = 3
    ast::AssignmentStmt* stmt1 = makeAssignmentStmt(ast::makeName("a"), ast::makeLiteralInt(1));
    ast::AssignmentStmt* stmt2 = makeAssignmentStmt(ast::makeName("b"), ast::makeLiteralInt(2));
    ast::AssignmentStmt* stmt3 = makeAssignmentStmt(ast::makeName("c"), ast::makeLiteralInt(3));

    codegen->eval(stmt1);
    codegen->eval(stmt2);
    codegen->eval(stmt3);

    EXPECT_DOUBLE_EQ(env->get(StringRef("a")).toFloat(), 1);
    EXPECT_DOUBLE_EQ(env->get(StringRef("b")).toFloat(), 2);
    EXPECT_DOUBLE_EQ(env->get(StringRef("c")).toFloat(), 3);
}
...
TEST_F(CodeGeneratorTest, AssignmentStmtWithVariableReference)
{
    ...
    // y = x + 5
    ast::AssignmentStmt* stmt = makeAssignmentStmt(ast::makeName("y"),
        makeBinary(ast::makeName("x"), ast::makeLiteralInt(5), ast::BinaryOp::OP_ADD));

    codegen->eval(stmt);

    EXPECT_DOUBLE_EQ(env->get(StringRef("y")).toFloat(), 15);
}
...
TEST_F(CodeGeneratorTest, ExprStmtWithSideEffects)
{
    ...
    ast::ExprStmt* stmt = ast::makeExprStmt(ast::makeAssignmentExpr(ast::makeName("x"), ast::makeLiteralInt(5)));
    ...
    EXPECT_TRUE(env->exists(StringRef("x")));
    EXPECT_DOUBLE_EQ(env->get(StringRef("x")).toFloat(), 5);
}
...
{
    // { x = 10 }
    ast::BlockStmt* block = ast::makeBlock({ makeAssignmentStmt(ast::makeName("x"), ast::makeLiteralInt(10)) });
...
{
    // { a = 1; b = 2; c = 3; }
    ast::BlockStmt* block = ast::makeBlock({ makeAssignmentStmt(ast::makeName("a"), ast::makeLiteralInt(1)),
        makeAssignmentStmt(ast::makeName("b"), ast::makeLiteralInt(2)),
        makeAssignmentStmt(ast::makeName("c"), ast::makeLiteralInt(3)) });
...
{
    // { 10; 20; 30; }
    ast::BlockStmt* block = ast::makeBlock({ makeExprStmt(ast::makeLiteralInt(10)),
        makeExprStmt(ast::makeLiteralInt(20)),
        makeExprStmt(ast::makeLiteralInt(30)) });
...
{
    // { x = 5; x + 10; y = x * 2; }
    ast::BlockStmt* block = ast::makeBlock({ makeAssignmentStmt(ast::makeName("x"), ast::makeLiteralInt(5)),
        makeExprStmt(makeBinary(ast::makeName("x"), ast::makeLiteralInt(10), ast::BinaryOp::OP_ADD)),
        makeAssignmentStmt(ast::makeName("y"), makeBinary(ast::makeName("x"), ast::makeLiteralInt(2), ast::BinaryOp::OP_MUL)) });

    codegen->eval(block);

    EXPECT_DOUBLE_EQ(env->get(StringRef("x")).toFloat(), 5);
    EXPECT_DOUBLE_EQ(env->get(StringRef("y")).toFloat(), 10);
}
...
{
    // if (true) { x = 10 }
    ast::BlockStmt* thenBlock = ast::makeBlock({ makeAssignmentStmt(ast::makeName("x"), ast::makeLiteralInt(10)) });
    ast::IfStmt* ifStmt = makeIf(ast::makeLiteralBool(true), thenBlock);
...
TEST_F(CodeGeneratorTest, IfElseStmtTrueCondition)
{
    ...
    ast::BlockStmt* thenBlock = ast::makeBlock({ makeAssignmentStmt(ast::makeName("x"), ast::makeLiteralInt(10)) });
    ast::BlockStmt* elseBlock = ast::makeBlock({ makeAssignmentStmt(ast::makeName("x"), ast::makeLiteralInt(20)) });
...
TEST_F(CodeGeneratorTest, IfElseStmtFalseCondition)
{
    ...
    EXPECT_DOUBLE_EQ(env->get(StringRef("x")).toFloat(), 20);
}

TEST_F(CodeGeneratorTest, IfStmtComparisonCondition)
{
    // if (5 > 3) { result = 1 }
    ast::BinaryExpr* condition = makeBinary(ast::makeLiteralInt(5), ast::makeLiteralInt(3), ast::BinaryOp::OP_GT);
    ast::BlockStmt* thenBlock = ast::makeBlock({ makeAssignmentStmt(ast::makeName("result"), ast::makeLiteralInt(1)) });
    ast::IfStmt* ifStmt = makeIf(condition, thenBlock);

    codegen->eval(ifStmt);

    EXPECT_TRUE(env->exists(StringRef("result")));
    EXPECT_DOUBLE_EQ(env->get(StringRef("result")).toFloat(), 1);
}
...
TEST_F(CodeGeneratorTest, IfStmtVariableCondition)
{
    ...
    ast::BlockStmt* thenBlock = ast::makeBlock({ makeAssignmentStmt(ast::makeName("y"), ast::makeLiteralInt(5)) });
...
TEST_F(CodeGeneratorTest, IfStmtNestedIf_01)
{
    ...
    ast::BlockStmt* innerThen = ast::makeBlock({ makeAssignmentStmt(ast::makeName("x"), ast::makeLiteralInt(10)) });
    ast::IfStmt* innerIf = makeIf(ast::makeLiteralBool(true), innerThen);
...
TEST_F(CodeGeneratorTest, IfStmtReturnValue)
{
    ...
    ast::BlockStmt* thenBlock = ast::makeBlock({ makeExprStmt(ast::makeLiteralInt(42)) });
    ast::IfStmt* ifStmt = makeIf(ast::makeLiteralBool(true), thenBlock);
...
{
    // i = 0; while (i < 3) { i = i + 1 }
    env->define(StringRef("i"), IR::Value::makeFloat(0));

    ast::BinaryExpr* condition = makeBinary(ast::makeName("i"), ast::makeLiteralInt(3), ast::BinaryOp::OP_LT);
    ast::BlockStmt* body = ast::makeBlock({ makeAssignmentStmt(ast::makeName("i"), makeBinary(ast::makeName("i"), ast::makeLiteralInt(1), ast::BinaryOp::OP_ADD)) });

    ast::WhileStmt* whileStmt = makeWhile(condition, body);
    codegen->eval(whileStmt);

    EXPECT_DOUBLE_EQ(env->get(StringRef("i")).toFloat(), 3);
}

TEST_F(CodeGeneratorTest, WhileStmtFalseConditionNeverExecutes)
{
    // while (false) { x = 10 }
    ast::BlockStmt* body = ast::makeBlock({ makeAssignmentStmt(ast::makeName("x"), ast::makeLiteralInt(10)) });
...
TEST_F(CodeGeneratorTest, WhileStmtCounterAccumulation)
{
    ...
    env->define(StringRef("sum"), IR::Value::makeFloat(0));
    env->define(StringRef("i"), IR::Value::makeFloat(1));

    ast::BinaryExpr* condition = makeBinary(ast::makeName("i"), ast::makeLiteralInt(5), ast::BinaryOp::OP_LTE);
    ast::BlockStmt* body = ast::makeBlock({ ast::makeAssignmentStmt(ast::makeName("sum"), ast::makeBinary(ast::makeName("sum"), ast::makeName("i"), ast::BinaryOp::OP_ADD)),
        makeAssignmentStmt(ast::makeName("i"), makeBinary(ast::makeName("i"), ast::makeLiteralInt(1), ast::BinaryOp::OP_ADD)) });

    ast::WhileStmt* whileStmt = makeWhile(condition, body);
    codegen->eval(whileStmt);

    // sum should be 1+2+3+4+5 = 15
    EXPECT_DOUBLE_EQ(env->get(StringRef("sum")).toFloat(), 15);
    EXPECT_DOUBLE_EQ(env->get(StringRef("i")).toFloat(), 6);
}
...
TEST_F(CodeGeneratorTest, WhileStmtWithComplexCondition)
{
    ...
    ast::BinaryExpr* condition = makeBinary(ast::makeName("x"), ast::makeLiteralInt(0), ast::BinaryOp::OP_GT);
    ast::BlockStmt* body = ast::makeBlock({ makeAssignmentStmt(ast::makeName("x"), ast::makeBinary(ast::makeName("x"), ast::makeLiteralInt(1), ast::BinaryOp::OP_SUB)) });

    ast::WhileStmt* whileStmt = makeWhile(condition, body);
    codegen->eval(whileStmt);

    EXPECT_DOUBLE_EQ(env->get(StringRef("x")).toFloat(), 0);
}
...
TEST_F(CodeGeneratorTest, WhileStmtNestedLoop)
{
    ...
    EXPECT_DOUBLE_EQ(env->get(StringRef("ا")).toFloat(), 3);
    EXPECT_DOUBLE_EQ(env->get(StringRef("م")).toFloat(), 2);
}
...
TEST_F(CodeGeneratorTest, FuncDefSimpleNoParams)
{
    ...
    ast::BlockStmt* body = ast::makeBlock({ makeExprStmt(ast::makeLiteralInt(42)) });
...
{
    // function setX() { x = 100 }
    ast::AssignmentStmt* x = ast::makeAssignmentStmt(ast::makeName("x"), ast::makeLiteralInt(0));
    codegen->eval(x); // declare x

    ast::BlockStmt* body = ast::makeBlock({ ast::makeAssignmentStmt(ast::makeName("x"), ast::makeLiteralInt(100)) });
    ...
    EXPECT_TRUE(env->exists(StringRef("x")));
    EXPECT_DOUBLE_EQ(env->get(StringRef("x")).toFloat(), 100);
}
...
TEST_F(CodeGeneratorTest, FuncDefClosure)
{
    ...
    env->define(StringRef("outer"), IR::Value::makeFloat(10));
...
TEST_F(CodeGeneratorTest, FuncDefMultipleFunctions)
{
    ...
    ast::BlockStmt* body1 = ast::makeBlock({ makeExprStmt(ast::makeLiteralInt(1)) });
    ast::BlockStmt* body2 = ast::makeBlock({ makeExprStmt(ast::makeLiteralInt(2)) });
...
TEST_F(CodeGeneratorTest, IntegratedIfWithinWhile)
{
    ...
    EXPECT_DOUBLE_EQ(env->get(StringRef("جمع")).toFloat(), 20);
}
...
TEST_F(CodeGeneratorTest, IntegratedFunctionWithIfElse)
{
    ...
    ast::BinaryExpr* condition = makeBinary(ast::makeName("x"), ast::makeLiteralInt(0), ast::BinaryOp::OP_LT);
    ast::BlockStmt* thenBlock = ast::makeBlock({ ast::makeExprStmt(ast::makeUnary(ast::makeName("x"), ast::UnaryOp::OP_NEG)) });
...
TEST_F(CodeGeneratorTest, IntegratedBlockWithMultipleStatementTypes)
{
    ...
    //      result = 0
    //   result
    ast::BinaryExpr* condition = makeBinary(ast::makeName("x"), ast::makeName("y"), ast::BinaryOp::OP_LT);
    ast::BlockStmt* thenBlock = ast::makeBlock({ makeAssignmentStmt(ast::makeName("result"), ast::makeLiteralInt(1)) });
    ast::BlockStmt* elseBlock = ast::makeBlock({ makeAssignmentStmt(ast::makeName("result"), ast::makeLiteralInt(0)) });
    ast::IfStmt* ifStmt = makeIf(condition, thenBlock, elseBlock);

    ast::BlockStmt* block = ast::makeBlock({ makeAssignmentStmt(ast::makeName("x"), ast::makeLiteralInt(10)),
        makeAssignmentStmt(ast::makeName("y"), ast::makeLiteralInt(20)), ifStmt, ast::makeExprStmt(ast::makeName("result")) });
