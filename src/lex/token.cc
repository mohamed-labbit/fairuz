...
{
    if (Type_ == TokenType::INDENT
        || Type_ == TokenType::DEDENT
        || Type_ == TokenType::BEGINMARKER
        || Type_ == TokenType::ENDMARKER)
        return Type_ == other.Type_;

    return Value_ == other.Value_
        && Type_ == other.Type_
        && Location_.line == other.Location_.line
...
StringRef const& Token::lexeme() const
{
    return Value_;
}

TokenType const& Token::type() const
{
    return Type_;
}
...
size_t const& Token::line() const
{
    return Location_.line;
}

size_t const& Token::column() const
{
    return Location_.column;
}

Location const& Token::location() const
{
    return Location_;
}

std::string const& Token::filepath() const
{
    return Location_.filepath;
}

bool Token::is(TokenType const tt) const
{
    return tt == Type_;
}

// is at beginning of a new line
bool Token::atbol() const
{
    return Atbol_;
}
...
{
    return static_cast<int>(lexeme().toDouble());
}
