...
static const std::unordered_map<std::wstring, TokenType, WStringHash> operators = {
  {L"=", TokenType::EQ},    {L":=", TokenType::ASSIGN}, {L"+", TokenType::PLUS},
  {L"-", TokenType::MINUS}, {L"*", TokenType::STAR},    {L"/", TokenType::SLASH},
  {L"<", TokenType::LT},    {L">", TokenType::GT},      {L"<=", TokenType::LE},
  {L">=", TokenType::GE}};

static const std::unordered_map<std::wstring, TokenType, WStringHash> keywords = {
  {L"خطا", TokenType::KW_FALSE},   {L"عدم", TokenType::KW_NONE},
  {L"صحيح", TokenType::KW_TRUE},   {L"و", TokenType::AND},
  {L"اخرج", TokenType::KW_RETURN}, {L"اكمل", TokenType::KW_CONTINUE},
  {L"عرف", TokenType::KW_FN},      {L"او", TokenType::OR},
  {L"بكل", TokenType::KW_FOR},     {L"اذا", TokenType::KW_IF},
  {L"ليس", TokenType::NOT},        {L"ارجع", TokenType::KW_RETURN},
