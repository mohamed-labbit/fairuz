...
class _PrimitiveObject
{
   ...
   public:
    ...
    _PrimitiveObject(T&& __arg)
    {
        ...
        if constexpr (std::is_same_v<std::decay_t<T>, long long>
    ...
    _PrimitiveObject operator+(const _Object& __other) const
    {
        if ((__type_ == _PrimitiveType::__INTEGER__ || __type_ == _PrimitiveType::__FLOAT__)
          && (__other.__type_ == _PrimitiveType::__INTEGER__
            || __other.__type_ == _PrimitiveType::__FLOAT__))
            return _PrimitiveObject(__float_ + __other.__float_);
        else if (__type_ == _PrimitiveType::__STRING__
          && __other.__type_ == _PrimitiveType::__STRING__)
    ...
    _PrimitiveObject operator&(const _Object& __other) const
    {
        if ((__type_ == _PrimitiveType::__INTEGER__ || __type_ == _PrimitiveType::__FLOAT__)
          ...
          && __other.__type_ == _PrimitiveType::__BOOLEAN__)
    ...
    {
        return greater_than(__other) || (*this == __other);
    }
    ...
    {
        return less_than(__other) || (*this == __other);
    }
