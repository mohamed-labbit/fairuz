...
struct Allocator {
private:
    allocator::ArenaAllocator Allocator_;

public:
    Allocator()
        : Allocator_(static_cast<std::int32_t>(allocator::ArenaAllocator::GrowthStrategy::EXPONENTIAL))
    {
        Allocator_.setName("Compiler Allocator");
    }
...
inline Allocator runtime_allocator;
