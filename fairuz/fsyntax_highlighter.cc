...
private:
    ...
    void target(AST::ConstExprPtr expression)
    {
        ...
        } else if (expression->get_kind() == AST::ExprKind::GET) {
    ...
    void expr(AST::ConstExprPtr expression)
    {
        ...
        case AST::ExprKind::OP_POW:
        case AST::ExprKind::OP_EQ:
        case AST::ExprKind::OP_NEQ:
        case AST::ExprKind::OP_LT:
        case AST::ExprKind::OP_GT:
        case AST::ExprKind::OP_LTE:
        case AST::ExprKind::OP_GTE:
        case AST::ExprKind::OP_BITAND:
        case AST::ExprKind::OP_BITOR:
        case AST::ExprKind::OP_BITXOR:
        case AST::ExprKind::OP_LSHIFT:
        case AST::ExprKind::OP_RSHIFT:
        case AST::ExprKind::OP_AND:
        case AST::ExprKind::OP_OR: {
            auto* value = AST::as_binary(expression);
            expr(value->lhs);
            expr(value->rhs);
            break;
        }
        case AST::ExprKind::OP_PLUS:
        case AST::ExprKind::OP_NEG:
        case AST::ExprKind::OP_BITNOT:
        case AST::ExprKind::OP_NOT:
        ...
        case AST::ExprKind::CALL: {
            ...
            else if (call->callee->get_kind() == AST::ExprKind::GET) {
        ...
        case AST::ExprKind::LIST:
            for (AST::ExprPtr item : AST::as_list(expression)->elements)
                expr(item);
            break;
